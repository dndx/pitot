...
fn latlon_to_gdl90(mut d: f32) -> (u8, u8, u8) {
    ...
    (((wk & 0xFF0000) >> 16) as u8, ((wk & 0x00FF00) >> 8) as u8, (wk & 0x0000FF) as u8)
}
...
mod tests {
    ...
    fn test_generate_traffic() {
        ...
        let mut trfc = Target::new((0xA1B2C3, AddressType::ADSBICAO),
                                   clock,
                                   TrafficSource::ES,
                                   None);
        ...
        let expected = [0x7E, 0x14, 0x00, 0xA1, 0xB2, 0xC3, 0x1A, 0xD8, 0x3F, 0xA8, 0xDE, 0xAF,
                        0x23, 0xF9, 0x79, 0x04, 0x2F, 0xF0, 0x57, 0x03, 'e' as u8, 'a' as u8,
                        'T' as u8, 'E' as u8, 'S' as u8, 'T' as u8, '1' as u8, '2' as u8, 0x00,
                        0x4D, 0xDE, 0x7E];
        ...
        let expected = [0x7E, 0x14, 0x00, 0xA1, 0xB2, 0xC3, 0x1A, 0xD8, 0x3F, 0xA8, 0xDE, 0xAF,
                        0x23, 0xF9, 0x79, 0x04, 0x2F, 0xF0, 0x57, 0x03, 'e' as u8, 'a' as u8,
                        '0' as u8, '1' as u8, '2' as u8, '3' as u8, 0x00, 0x00, 0x00, 0x87, 0xEC,
                        0x7E];
